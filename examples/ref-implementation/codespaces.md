...
- Get the latest release:
  ```bash
  version=$(curl -Ls -o /dev/null -w %{url_effective} https://github.com/nimakaviani/idpbuilder/releases/latest)
  version=${version##*/}
  wget https://github.com/nimakaviani/idpbuilder/releases/download/${version}/idpbuilder-linux-amd64.tar.gz
